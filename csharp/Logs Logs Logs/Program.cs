...
static class LogLine
{
    ...
    public static string OutputForShortLog(LogLevel logLevel, string message)
    {
        switch (logLevel)
        {
            case LogLevel.Trace: return "1:" + message;
            case LogLevel.Debug: return "2:" + message;
            case LogLevel.Info: return "4:" + message;
            case LogLevel.Warning: return "5:" + message;
            case LogLevel.Error: return "6:" + message;
            case LogLevel.Fatal: return "42:" + message;
